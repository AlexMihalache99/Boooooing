...
public class Oval extends ClosedShape {
	 ...
	 * @param isPulsing True if the oval is pulsing, false if not.
	 */
	public Oval(String shape, int insertionTime, int x, int y, int vx, int vy, int width, int height, Color colour,boolean isFilled, boolean isPulsing) {
