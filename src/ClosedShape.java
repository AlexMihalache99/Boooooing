...
public class ClosedShape {
	...
	/**
	 *The type of the shape e.g circle,oval,rect,square,arc 
	 * */
	...
	/**
	 * The line colour of the shape, or the filled in colour if the Shape has
	 * fill.
	 */
	...
	/**
	 * Determine if the shape size is increasing or decreasing
	 * */
	private int turn = 2;
	 ...
	 *            the velocity of y.
	 * @param colour
	 *            The line or fill colour.
	 * @param isFilled
	 *            True if the shape is filled, false if not.
	 * @param isPulsing
	 *            True if the shape is pulsing, false if not.
	 */
	protected ClosedShape(String shape, int insertionTime, int x, int y, int vx, int vy, Color colour, boolean isFilled,boolean isPulsing) {
	...
	/**
	 * Takes in a direction and a velocity and moves the shape in that direction
	 * on unit
	 */
	public void move() {
		x += xVec;
	...
	/**
	 * 	This method helps us to know what the shape should do:shrinking or growing
	 * 1 for growing 2 for shrinking
	 * 
	 *  @param turn 
	 * 
	 * If turn is 1 it will be 2
	 * If turn is 2 it will be 1
	 * */
	...
	/**
	 * 
	 * @return turn 1 if the shape is growing or 2 if is shrinking
	 * */
	public int getTurn() {
		return this.turn;
	}
	 ...
	 * 
	 * @param g
	 *            The graphics object associated with the drawing component.
	 */
